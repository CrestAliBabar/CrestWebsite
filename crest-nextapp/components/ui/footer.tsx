...
import CrestLogo from '@/public/images/crest-logo.jpg'
    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12">
          ...
          <div className="sm:col-span-12 lg:col-span-4 lg:max-w-xs">
            <div className="mb-2">
              ...
              {/* <Link href="/" className="inline-flex text-blue-600 transition duration-150 ease-in-out" aria-label="Cruip"> */}
                ...
                <Image className="inline-flex text-blue-600 transition duration-150 ease-in-out" src={CrestLogo} width={50} height={30} alt="Logo"/>
            ...
            <div className="text-lg font-bold text-slate-800">Your potential is our priority.</div>
          </div>
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm font-medium space-y-2">
              ...
              <li>
                <a href="#" className="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out">Consulting</a>
              </li>
              {/* <li>
          ...
          {/* 3rd block */}
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-sm text-slate-800 font-semibold mb-2">Technology Products</h6>
            <ul className="text-sm font-medium space-y-2">
              <li>
                <a href="#" className="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out">Blockchin</a>
              </li>
              <li>
                <a href="#" className="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out">Software Security</a>
              </li>
              <li>
                <a href="#" className="text-slate-500 hover:text-blue-600 transition duration-150 ease-in-out">Distributed System</a>
              </li>
            </ul>
          </div>
        ...
        <div className="md:flex md:items-center md:justify-between py-6 md:py-8 border-t border-slate-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-slate-500 mr-4">© Crest.com. All rights reserved.</div>
