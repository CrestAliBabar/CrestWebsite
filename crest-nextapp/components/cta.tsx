        ...
        <div className="py-12 md:py-20">
          ...
          <div className="relative max-w-3xl mx-auto text-center">
            ...
            <div className="relative">
              <h2 className="h2 font-playfair-display text-slate-800 mb-4">Pursue your passion and <span className="text-emerald-500">join CREST</span>.</h2>
              <p className="text-xl text-slate-500 mb-8">Pursue your passion and work alongside world-recognized leaders in the field of software engineering. We invite you to view current employment opportunities, learn about benefits of working at the CREST, and apply for a position.</p>
              <div>
